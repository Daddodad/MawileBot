...
2. Ogni modifica a ./src può E DEVE essere spostata su SableyeBot.
   FARE ATTENZIONE ALL'USO DI PATH A FOLDER, USATE *ENV_PATH*.
...
4. Se aggiungete files, cercate di farlo in modo ordinato nella cartella src o in sottocartelle.
   Ricordatevi di spostarle poi su SableyeBot.
